...
namespace Ohunini.Business.Models
{
        ...
        where T : class
    {
        ...
        {
            var response = new Response<T> { ResultType = ResultType.UnAuthorized, Message = errorMessage };
        ...
        {
            var response = new Response<T> { ResultType = ResultType.NotFound, Message = errorMessage };
        ...
        /// <param name="validationMessages">The validation message</param>
        /// <returns>The Response object</returns>
        public new static Response<T> ValidationError(List<ValidationError> validationMessages, List<string> validationMessageslst)
        {
            var response = new Response<T> { ResultType = ResultType.ValidationError, Message = "Response has validation errors", ValidationErrors = validationMessages, ValidationMessages = validationMessageslst };
